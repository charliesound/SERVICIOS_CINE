  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm max-w-md w-full">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Plataforma Lista</h2>
        <p className="text-gray-500 mb-8">No hay un proyecto activo en este momento. Comienza inicializando la demo o importa un archivo de proyecto.</p>
