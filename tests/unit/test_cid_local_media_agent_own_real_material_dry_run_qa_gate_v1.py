...
DOC = ROOT / "docs/product/local_media_agent/cid_local_media_agent_own_real_material_dry_run_qa_gate_v1.md"
...
PHASE = "CID.LOCAL_MEDIA_AGENT.OWN_REAL_MATERIAL.DRY_RUN.QA.GATE.V1"
STARTING_HEAD = "03fb9180ae2a13060022aaecd355180906631d89"
STARTING_STATE = "OWN_REAL_MATERIAL_DRY_RUN_IMPLEMENTATION_GATE_CLOSED_REMOTE_VERIFIED"
PREVIOUS_PHASE = "CID.LOCAL_MEDIA_AGENT.OWN_REAL_MATERIAL.DRY_RUN.IMPLEMENTATION.GATE.V1"
TARGET_NEXT_STATE = "OWN_REAL_MATERIAL_DRY_RUN_QA_GATE_PASSED_READY_FOR_OWN_REAL_MATERIAL_DRY_RUN_EXECUTION_READINESS_GATE"
...
def test_document_declares_module_properties() -> None:
    text = _text(DOC)
    _assert_all_present(text, [
...
def test_required_artifacts_exist_and_are_referenced() -> None:
    text = _text(DOC)
    for path in [IMPL_DOC, IMPL_TEST, MODULE]:
