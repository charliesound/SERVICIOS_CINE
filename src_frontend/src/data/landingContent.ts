...
export const landingContent = {
  ...
  pricing: {
    eyebrow: 'Precios y créditos GPU',
    title: 'Planes de suscripción para preproducción cinematográfica con IA.',
    description:
      'Cada plan incluye créditos mensuales de GPU para generar imágenes, storyboards, referencias visuales, biblias visuales y otros materiales creativos. Si tu equipo necesita más capacidad, puedes ampliar con packs extra de créditos sin cambiar de plan.',
    tagline:
    ...
    plans: [
      {
        ...
        maxProjects: 1,
        features: [
          'Análisis básico de guion',
          'Breakdown inicial',
          'Storyboard limitado',
          'Exportación PDF/PNG',
        ],
        extraCredits: { amount: 500, price: '49' },
        badge: null,
        ctaLabel: 'Empezar con CID',
        highlighted: false,
      },
      {
        id: 'pro',
        ...
        maxProjects: 3,
        features: [
          'Análisis avanzado de guion',
          'Breakdown por escenas',
          'Storyboard por escenas',
          'Visual Bible básica',
          'Character Bible básica',
          'Control inicial de raccord visual',
        ],
        extraCredits: [
          { amount: 1500, price: '119' },
          { amount: 3000, price: '229' },
        ],
      ...
      },
      {
        ...
        maxProjects: null,
        features: [
          'Storyboard por escenas y secuencias',
          'Visual Bible avanzada',
          'Character Bible avanzada',
          'Raccord de personajes, vestuario, decorado y atmósfera',
          'Dossier pitch básico',
          'Exportación PDF/PNG/ZIP',
          'Cola prioritaria',
        ],
        extraCredits: { amount: 10000, price: '699' },
      ...
      },
      {
        ...
        features: [
          ...
          'Cola prioritaria avanzada',
          'Dossier pitch profesional',
          'Presupuesto preliminar',
          'Documentos de producción',
          'Soporte directo',
        ],
        extraCredits: { amount: null, price: '0,12–0,20 €/crédito' },
        badge: 'Profesional',
        ctaLabel: 'Ver plan',
        highlighted: false,
      },
      {
        ...
        features: [
          'Créditos a medida',
          'GPU dedicada o semidedicada',
          'Instalación privada o entorno dedicado',
          'Usuarios por departamento',
          'Roles y permisos',
          'Seguridad avanzada con backups',
        ...
        highlighted: false,
        setupFees: [
          { name: 'Enterprise básico', price: '5.000' },
          { name: 'Enterprise avanzado', price: '10.000' },
          { name: 'Enterprise a medida', price: '15.000' },
        ],
      },
    ],
    creditExplain: {
      title: 'Cómo funcionan los créditos GPU',
      subtitle:
        'Cada plan incluye créditos mensuales de GPU para generar imágenes, storyboards, referencias visuales, biblias visuales y otros materiales creativos. Los créditos se renuevan cada mes.',
      rules: [
        'En Starter los créditos no se acumulan. En Pro, Studio y Premium se puede acumular hasta un 20% para el mes siguiente.',
        'Los créditos extra comprados tienen una validez de 90 días.',
        'El vídeo IA consume más créditos que la imagen.',
        'Los planes superiores tienen prioridad de cola.',
        'Créditos sirven para generar imágenes, storyboards, referencias visuales, biblias visuales y otros materiales creativos.',
      ],
    },
    extraPacks: {
      title: 'Packs extra de créditos',
      description:
        'Amplía la capacidad de tu plan sin cambiar de suscripción. Los packs extra se activan al instante y tienen validez de 90 días.',
      packs: [
        { plan: 'Starter', amount: 500, price: '49 €' },
        { plan: 'Pro', amount: 1500, price: '119 €' },
        { plan: 'Pro', amount: 3000, price: '229 €' },
        { plan: 'Studio', amount: 10000, price: '699 €' },
        { plan: 'Premium', desc: '0,12–0,20 €/crédito', price: 'A medida' },
      ],
    },
  },
  audience: {
