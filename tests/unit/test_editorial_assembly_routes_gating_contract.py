"""
Contract test: editorial_assembly_routes.py gating invariants.

Verifies that editorial assembly endpoints require tenant context,
...
TARGET_FILE = ROUTES_DIR / "editorial_assembly_routes.py"

MANUAL_REVIEW_ENDPOINTS = [
    '"/{project_id}/editorial/reports/{report_id}"',
]
