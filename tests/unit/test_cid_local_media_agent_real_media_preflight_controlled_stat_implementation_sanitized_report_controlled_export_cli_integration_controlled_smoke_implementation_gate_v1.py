...
DOC = ROOT / "docs/product/local_media_agent/cid_local_media_agent_real_media_preflight_controlled_stat_implementation_sanitized_report_controlled_export_cli_integration_controlled_smoke_implementation_gate_v1.md"
...
EXPECTED_RESULT = (
    ...
    "CONTROLLED_EXPORT_CLI_INTEGRATION_CONTROLLED_SMOKE_IMPLEMENTATION_GATE_V1_CLOSED"
)
STARTING_HEAD = "ffb16ae8e26aaebf6e279e5ee3af461fbcb4d083"
STARTING_STATE = "CONTROLLED_SMOKE_READINESS_GATE_CLOSED_REMOTE_VERIFIED"
PREVIOUS_PHASE = (
    "CID.LOCAL_MEDIA_AGENT.REAL_MEDIA_PREFLIGHT.CONTROLLED_STAT_IMPLEMENTATION."
    "SANITIZED_REPORT.CONTROLLED_EXPORT.CLI_INTEGRATION."
