...
TARGET_TAG = (
    ...
    "renderer-cli-visible-report-output-export-controlled-text-artifact-contract-qa-gate-v1-20260622"
)
NEXT_PHASE = (
    "CID.LOCAL_MEDIA_AGENT.FFPROBE.CONTROLLED.FILE.METADATA.PREFLIGHT."
...
def test_qa_gate_declares_no_export_no_packaging_no_files() -> None:
    assert_all_present(read(QA_DOC), [
...
def test_contract_doc_declares_controlled_text_artifact_definition() -> None:
    assert_all_present(read(CONTRACT_DOC), [
        "text-only artifact",
