...
async def generate_storyboard(
    ...
    result = await storyboard_service.generate_storyboard(
        ...
        pose_reference_image=payload.pose_reference_image,
        character_reference_images=payload.character_reference_images,
        reference_strength=payload.reference_strength,
        ipadapter_weight=payload.ipadapter_weight,
        ipadapter_model=payload.ipadapter_model,
        clip_vision_model=payload.clip_vision_model,
        start_at=payload.start_at,
        end_at=payload.end_at,
        controlnet_hints=payload.controlnet_hints,
        controlnet_strength=payload.controlnet_strength,
        controlnet_preprocessor=payload.controlnet_preprocessor,
        controlnet_model=payload.controlnet_model,
