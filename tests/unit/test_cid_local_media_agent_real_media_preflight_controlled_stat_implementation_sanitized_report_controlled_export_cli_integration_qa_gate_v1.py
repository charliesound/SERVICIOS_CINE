...
QA_DOC = ROOT / "docs/product/local_media_agent/cid_local_media_agent_real_media_preflight_controlled_stat_implementation_sanitized_report_controlled_export_cli_integration_qa_gate_v1.md"
IMPL_DOC = ROOT / "docs/product/local_media_agent/cid_local_media_agent_real_media_preflight_controlled_stat_implementation_sanitized_report_controlled_export_cli_integration_implementation_gate_v1.md"
IMPL_TEST = ROOT / "tests/unit/test_cid_local_media_agent_real_media_preflight_controlled_stat_implementation_sanitized_report_controlled_export_cli_integration_implementation_gate_v1.py"
...
EXPECTED_RESULT = (
    ...
    "CONTROLLED_EXPORT_CLI_INTEGRATION_QA_GATE_V1_CLOSED"
)
STARTING_HEAD = "f146c4d1a4fe79d7be75e2125d7196af9d02bdc6"
STARTING_STATE = "CONTROLLED_EXPORT_CLI_INTEGRATION_IMPLEMENTATION_GATE_CLOSED_REMOTE_VERIFIED"
PREVIOUS_PHASE = (
    "CID.LOCAL_MEDIA_AGENT.REAL_MEDIA_PREFLIGHT.CONTROLLED_STAT_IMPLEMENTATION."
...
def _markdown() -> str:
    request = ControlledStatImplementationRequest(
        input_record_id="cli_qa_gate_input_001",
        sanitized_selection_token="LOCAL_OPERATOR_TOKEN_MUST_NOT_EXPORT",
        manual_confirmation_handle="CLI_QA_MANUAL_HANDLE_001",
        isolated_boundary_handle="CLI_QA_BOUNDARY_HANDLE_001",
        skeleton_handle="CLI_QA_SKELETON_HANDLE_001",
    )
...
def test_qa_gate_declares_cli_boundaries() -> None:
    text = _text(QA_DOC)
    _assert_all_present(text, [
...
def test_exporter_renderer_and_historical_clis_remain_unchanged() -> None:
...
def test_excluded_historical_tests_are_documented_but_not_in_battery() -> None:
    text = _text(QA_DOC)
    ...
    assert "This CLI integration QA gate test." in text
    assert "The CLI integration implementation gate test." in text


def test_qa_doc_and_test_contain_no_windows_or_mount_paths() -> None:
