...
DOC_PATH = REPO_ROOT / "docs/product/local_media_agent/cid_local_media_agent_controlled_local_demo_runner_operator_evidence_pack_gate_v1.md"
...
EXPECTED_RESULT = "LOCAL_MEDIA_AGENT_CONTROLLED_LOCAL_DEMO_RUNNER_OPERATOR_EVIDENCE_PACK_GATE_V1_CLOSED"
...
def _assert_evidence_payload(payload: dict) -> None:
...
def test_operator_evidence_pack_doc_freezes_demo_evidence() -> None:
    ...
    for blocked_line in [
        ...
        assert blocked_line in text


def test_operator_evidence_pack_help_output_is_presentable() -> None:
...
def test_operator_evidence_pack_default_json_is_self_cleaning_evidence() -> None:
    payload = _load_json()

    _assert_evidence_payload(payload)
...
def test_operator_evidence_pack_keep_output_json_is_inspection_evidence_and_cleans() -> None:
