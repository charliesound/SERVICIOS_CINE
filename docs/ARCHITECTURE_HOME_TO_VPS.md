...
```bash
# On home machine
docker execailinkcinema_backend tar czf /tmp/ailinkcinema_backup.tar.gz /app/data
docker cpailinkcinema_backend:/tmp/ailinkcinema_backup.tar.gz ./backup.tar.gz
```
...
docker execailinkcinema_backend tar xzf /tmp/backup.tar.gz -C /
```
