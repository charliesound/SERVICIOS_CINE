  ...
  if (breakdown.length === 0) {
    return (
      <div className="rounded-xl border border-white/10 bg-dark-200/80 p-6 text-center">
        ...
        <p className="text-sm text-slate-400">No se detectaron personajes en las secuencias.</p>
      </div>
    )
  }
          ...
          >
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-xs text-slate-400">
                {entry.appearances} secuencia{entry.appearances !== 1 ? 's' : ''}
              </span>
            </div>
