"""
Contract test: script_version_routes.py gating invariants.

Verifies that script version endpoints require tenant context,
...
TARGET_FILE = ROUTES_DIR / "script_version_routes.py"
...
def test_inline_project_query_removed_from_project_endpoints():
    ...
    for line in source.splitlines():
        stripped = line.strip()
        assert "_get_project_for_tenant_or_404" not in stripped, (
