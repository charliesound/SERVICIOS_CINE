...
PHASE = "CID.LOCAL_MEDIA_AGENT.FFPROBE.CONTROLLED.FILE.METADATA.PREFLIGHT.VISIBLE.REPORT.RENDERER.CLI.VISIBLE.REPORT.OUTPUT.EXPORT.CONTROLLED.TEXT.ARTIFACT.CONTROLLED.EXPORT.PATH.IMPLEMENTATION.READINESS.CONTRACT.V1"
PREVIOUS_PHASE = "CID.LOCAL_MEDIA_AGENT.FFPROBE.CONTROLLED.FILE.METADATA.PREFLIGHT.VISIBLE.REPORT.RENDERER.CLI.VISIBLE.REPORT.OUTPUT.EXPORT.CONTROLLED.TEXT.ARTIFACT.CONTROLLED.EXPORT.PATH.CONTRACT.QA.GATE.CLOSURE.REVIEW.V1"
PREVIOUS_RESULT = "LOCAL_MEDIA_AGENT_FFPROBE_CONTROLLED_FILE_METADATA_VISIBLE_REPORT_RENDERER_CLI_VISIBLE_REPORT_OUTPUT_EXPORT_CONTROLLED_TEXT_ARTIFACT_CONTROLLED_EXPORT_PATH_CONTRACT_QA_GATE_CLOSURE_REVIEW_PASS_READY_FOR_CONTROLLED_EXPORT_PATH_IMPLEMENTATION_READINESS_CONTRACT"
RESULT = "LOCAL_MEDIA_AGENT_FFPROBE_CONTROLLED_FILE_METADATA_VISIBLE_REPORT_RENDERER_CLI_VISIBLE_REPORT_OUTPUT_EXPORT_CONTROLLED_TEXT_ARTIFACT_CONTROLLED_EXPORT_PATH_IMPLEMENTATION_READINESS_CONTRACT_PASS_READY_FOR_QA_GATE"
NEXT_PHASE = "CID.LOCAL_MEDIA_AGENT.FFPROBE.CONTROLLED.FILE.METADATA.PREFLIGHT.VISIBLE.REPORT.RENDERER.CLI.VISIBLE.REPORT.OUTPUT.EXPORT.CONTROLLED.TEXT.ARTIFACT.CONTROLLED.EXPORT.PATH.IMPLEMENTATION.READINESS.CONTRACT.QA.GATE.V1"
...
def test_controlled_export_path_implementation_readiness_contract_files_exist():
...
def test_controlled_export_path_implementation_readiness_contract_declares_phase_result_and_next_phase():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_references_previous_chain():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_is_doc_and_test_only():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_defines_future_scope():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_defines_allowed_inputs():
    text = _read(DOC_PATH)
    ...
    required_phrases = [
        ...
        "Descriptor metadata already marked as controlled and safe.",
        "Text artifact format already constrained to controlled visible report text.",
    ]
...
def test_controlled_export_path_implementation_readiness_contract_defines_forbidden_inputs():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_defines_validation_rules():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_defines_planned_descriptor_fields():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_declares_false_write_flags():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_boundary_is_explicit():
    text = _read(DOC_PATH)
...
def test_controlled_export_path_implementation_readiness_contract_non_authorization_is_complete():
    text = _read(DOC_PATH)
    lowered = text.lower()
...
def test_controlled_export_path_implementation_readiness_contract_previous_closure_supports_readiness():
...
def test_controlled_export_path_implementation_readiness_contract_previous_contract_contains_core_rules():
...
def test_controlled_export_path_implementation_readiness_contract_current_implementation_remains_pathless():
...
def test_controlled_export_path_implementation_readiness_contract_test_sources_have_no_external_execution_or_network_imports():
    for path in [TEST_PATH, PREVIOUS_CLOSURE_TEST_PATH, PREVIOUS_QA_GATE_TEST_PATH, PATH_CONTRACT_TEST_PATH]:
...
def test_controlled_export_path_implementation_readiness_contract_does_not_claim_runtime_or_client_readiness():
    combined = "\n".join(
        [
            _read(DOC_PATH),
