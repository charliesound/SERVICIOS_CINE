    ...
    return (
      <div className="max-w-md mx-auto text-center py-12">
        <div className="card bg-dark-200/80 backdrop-blur-xl">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">{t('internal.createJob.createdTitle')}</h2>
          <p className="text-slate-400 mb-6">
            {t('internal.createJob.createdMessagePrefix')} <span className="font-mono text-amber-400">{createdJobId}</span> {t('internal.createJob.createdMessageSuffix')}
          </p>
          <div className="flex flex-col gap-3">
            ...
            >
              {t('internal.createJob.viewInQueue')}
            </button>
            <button
              onClick={() => {
            ...
            >
              {t('internal.createJob.createAnother')}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="heading-lg flex items-center gap-3">
            ...
            {t('internal.createJob.title')}
          </h1>
          <p className="text-slate-400 mt-1">{t('internal.createJob.subtitle')}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="card card-hover">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-white">{t('internal.createJob.describeVision')}</h2>
          </div>
        ...
        <div className="space-y-4">
          <div className="card card-hover">
            <h2 className="text-lg font-semibold text-white mb-4">{t('internal.createJob.projectDetails')}</h2>
            <JobSubmitForm
              analysis={analysis}
          ...
          {planStatus && (
            <div className="card bg-dark-200/50">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-medium text-slate-300">{t('internal.createJob.yourPlan')}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 rounded-xl bg-dark-300/50">
                  ...
                  <p className="text-xs text-slate-400">{t('internal.createJob.activeJobs')}</p>
                </div>
                <div className="p-3 rounded-xl bg-dark-300/50">
                  <p className="text-2xl font-bold text-white">
                  ...
                  <p className="text-xs text-slate-400">{t('internal.status.queued')}</p>
                </div>
              </div>
