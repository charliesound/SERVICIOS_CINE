...
class ProjectFundingMatcherIntegrationTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.admin_headers = _auth_headers(ADMIN_A, "matcher_admin_a@example.com", roles=["global_admin"])
        cls.tenant_b_headers = _auth_headers(USER_B, "matcher_user_b@example.com", ORG_B)
        _seed_test_data()
